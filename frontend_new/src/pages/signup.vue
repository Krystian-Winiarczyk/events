...
<template>
  <div class="v-application__wrap">
    <VRow class="h-100">
      <VCol md="4" class="d-none d-md-flex align-center justify-center">
        <VImg src="https://www.pitpat.com/wp-content/uploads/2018/04/Celebrating-500px.png" style="height: 400px"></VImg>
      </VCol>
      <VCol md="8" cols="12" style="background-color: rgb(var(--v-theme-surface));">
        <!-- 👉 Stepper -->
        <AppStepper
