...
export default class Profile {
  ...
  private _pronouns: any
  private _language: any
  private _avatar: string | undefined
  private _dsc: string | undefined
  private _socials: Array<any> | undefined
  private _friends: Array<Profile> | undefined

  constructor(name: string, pronouns: any, language: any, nickname?: string, dsc?: string, avatar?: string, socials?: Array<any>, friends?: Array<Profile>) {
    this._name = name
  ...
  public get socials(): Array<any> { return this._socials || [] }
  public set socials(socials: Array<any>) { this._socials = socials }
